...
public class MoveFromListAndCreateNewList {
    ...
    public void move() throws InterruptedException {
        ...
        driver.findElement(By.xpath("//strong[@id='create_new_and_move']")).click();
    ...
    public static void clean() throws InterruptedException {
        driver.findElement(By.xpath("//label[@id='lblAllPersons']/i")).click();
        driver.findElement(By.xpath("//span[@id='drop-move']/u")).click();
        driver.findElement(By.xpath("//div[@id='pageContentBody']/div[8]/div/div[2]/div/div/div[2]/ul/li[3]/span")).click();
